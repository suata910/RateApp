...
//        recyclerView = (RecyclerView) rootView.findViewById(R.id.AppList2);
        chart = (HorizontalBarChart) rootView.findViewById(R.id.barChart2);
...
//        int[] icons = {R.drawable.ic_facebook, R.drawable.ic_mytracks};
        ...
        for (int i = 0; i < apps.size() && i < icons.length; i++) {
            ...
            App app = repo.getAppByName("MyTracks");
            current.iconID = icons[i];
            current.title = app.getName();
